 ...
 */
function citadela_blocks_init_spacer() {
...
add_action( 'init', 'citadela_blocks_init_spacer' );


function citadela_blocks_enqueue_assets_spacer() {
	$slug = "spacer";
...
add_action( 'enqueue_block_assets', 'citadela_blocks_enqueue_assets_spacer');